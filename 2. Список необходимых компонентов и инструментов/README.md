# Клиппер 13 был добавлен в [zmod](https://github.com/ghzserg/zmod) , усстанавливаете на свой принтер, обновляете его до последенй версии, нажимаете макрос update_mcu , и выполняете все указания из консоли флюида.
